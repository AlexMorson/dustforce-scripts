...
class ropedart {
    ...
    void rope() {
        ...
        switch (state) {
            case 1:
                mul = 1 - float(state_timer) / s.ext_time;
                break;
            case 2:
                mul = 1;
                break;
            case 3:
                mul = float(state_timer) / s.ret_time;
                break;
        }
        ...
        if (state_timer <= 0) {
            switch (state) {
                case 1:
                    // Stay out
                    state = 2;
                    state_timer = s.out_time;
                    break;
                case 2:
                    // Start retracting
                    state = 3;
                    state_timer = s.ret_time;
                    break;
                case 3:
                    // Idle
                    state = 0;
